...
class DiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diary" do
    assert_difference('Diary.count') do
      post diaries_url, params: { diary: { comment: @diary.comment, date: @diary.date, photo: @diary.photo } }
    end
  ...
  test "should update diary" do
    patch diary_url(@diary), params: { diary: { comment: @diary.comment, date: @diary.date, photo: @diary.photo } }
